# Generated by Django 5.1.1 on 2024-11-26 01:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('admin', 'Admin'), ('customer', 'Customer'), ('operator', 'Operator'), ('currier', 'Currier'), ('manager', 'Manager')], default='customer', max_length=200, verbose_name='Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager_fee', models.PositiveIntegerField(blank=True, help_text='In sum', null=True, verbose_name='Admin_profit')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.category', verbose_name='Category')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Mahsulotning Egasi')),
            ],
            options={
